            ...
            <div class="card-header d-flex justify-content-between">
                ...
                <div class="col d-flex justify-content-end">
                    <form action="<?= base_url('surat-masuk/approve') ?>" method="POST">
                        ...
                        <button class="btn m-1 btn-primary <?= $data['admin'] != 0 ? "disabled" : "" ?>" type="submit" <?= $data['admin'] != 0 ? "disable" : "" ?>>
                            Approve
                        </button>
                    </form>
                    <form action="<?= base_url('surat-masuk/reject') ?>" method="POST">
                        <input type="hidden" name="id_pengajuan" value="<?= $data['id_pengajuan'] ?>">
                        <input type="hidden" name="role_pm" value="<?= session()->get('role') ?>">
                        <button class="btn m-1 btn-danger <?= $data['admin'] != 0 ? "disabled" : "" ?>" type="submit" <?= $data['admin'] != 0 ? "disable" : "" ?>>
                            Reject
                        </button>
                    </form>
                </div>
