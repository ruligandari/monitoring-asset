...
<div class="page-content-wrapper">
    ...
    <div class="container">
        <div class="card">
            <div class="card-body">
                <form action="<?= base_url('barang-masuk/update') ?>" method="POST">
                    <div class="form-group">
                        <input type="hidden" name="id" value="<?= $data['id'] ?>">
                        <label class="form-label" for="exampleInputText">Nama Barang Masuk</label>
                        <input class="form-control" id="exampleInputText" type="text" name="nama" value="<?= $data['nama'] ?>" readonly>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="exampleInputemail">Kuantitas</label>
                        <input class="form-control" id="exampleInputemail" type="text" name="qty" value="<?= $data['qty'] ?>">
                    </div>
